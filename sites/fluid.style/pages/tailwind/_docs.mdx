...
way to handle it. Fluid variants will infer the start/end points from any screen or container variants **after** them,
and use those as the defaults rather than the global defaults.
For example:
