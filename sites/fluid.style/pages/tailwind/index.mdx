...
title: Fluid Tailwind CSS Plugin
---
...
<Steps.Root>
  ...
  <Steps.Item>
    **(Optional) Use `rem` screens and font sizes**
    ...
    If you're extending Tailwind's default `fontSize` and `screens`, you can use the included `rem` versions of them to ensure greater compatibility with core plugins.
