```html title="index.html" del=/( p-6.*?)"/ ins="~p-6/10" del=" text-lg lg:text-2xl" ins=/~text-lg\/2xl/ del=" mt-4 lg:mt-2.5" ins=/~mt-4\/2\.5/ del=" text-sm lg:text-base" ins=/~text-sm\/base/
<main class="~p-6/10 p-6 lg:p-10">
  <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
    <div class="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
      <h1 class="mt-1 ~text-lg/2xl text-lg lg:text-2xl font-semibold text-white sm:text-slate-900 dark:sm:text-white">Beach House in Collingwood</h1>
    ...
    <p class="mt-4 ~text-sm/base text-sm lg:text-base leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-400">
