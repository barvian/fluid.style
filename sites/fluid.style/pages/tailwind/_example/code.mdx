```html frame="terminal" mark=/(\~.*?)[\s"]/
<main class="~py-6/10 ~px-4/8">
  <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
    <div class="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
      <h1 class="mt-1 ~text-lg/2xl font-semibold text-white sm:text-slate-900 dark:sm:text-white">Beach House in Collingwood</h1>
    ...
    <dl class="~mt-4/2.5 text-xs font-medium flex items-center row-start-2 sm:row-start-3 lg:row-start-2">
    ...
    <p class="mt-4 ~text-sm/base leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-400">
